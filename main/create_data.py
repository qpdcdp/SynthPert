...
parser.add_argument(
    ...
    choices=["single_gene_prediction", "direct_prediction", "inverse_problem", "metabolic_flux", "seahorse_cluster", "inverse_problem_multiple_genes"],
...
parser.add_argument(
    ...
    type=str,
    default="default",
    choices=["bullet_list", "default"],
    help="Format of the list for up and downregulated genes.",
)

if __name__ == "__main__":
    args = parser.parse_args()
    if args.tool == "enrichr":
        from src.data_generation.create_synth_data_with_critic_tool import main
        main(args)

    elif args.synth_data_script == "with_critic":
        from src.data_generation.create_synth_data_with_critic import main
        main(args)
    elif args.synth_data_script == "without_critic":
        from src.data_generation.create_synth_data import main
        main(args)