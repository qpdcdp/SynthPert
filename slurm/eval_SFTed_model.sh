...
#SBATCH --output=/novo/projects/departments/mi/lwph/PertRL/logs/test_unsloth_lean/%x_%j.out
#SBATCH --error=/novo/projects/departments/mi/lwph/PertRL/logs/test_unsloth_lean/%x_%j.err
