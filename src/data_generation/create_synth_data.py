...
def main(args):
    ...
    prompt_type = "generation_lemmas" if args.generation_lemmas else "default_prompt"
    OUTPUT_CSV_FILE = args.output_dir + f"{args.generator_model_name}/{args.synth_data_script}/{split_name}_split_{prompt_type}.csv"
    # Percentage of training data to use for generation
    TRAIN_SUBSET_PERCENTAGE = 0.045
    ...
    try:
        ...
        full_train_dataset = DiffExpressionDataset(csv_dir=CSV_DATA_DIRECTORY, split="train", prompt_mode="o3_syth_data")
