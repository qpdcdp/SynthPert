...
def main(args):
    print("Starting triplet training script...")
...
# No changes needed for the tokenizer usually
    ...
    print(f"Loaded CSV file: {args.synth_data_csv}")
    ...
    def convert_to_conversational_format(df):
        ...
        for _, row in df.iterrows():
            ...
            messages.append({"role": "assistant", "content": formated_answer})
    ...
    output_dir = f"./output/SFT_trips_dir/{synth_data_name}/lora_triplet"
    training_args = TrainingArguments(
        ...
        optim="adamw_torch",
        learning_rate=1e-5, # LoRA often benefits from a slightly higher learning rate
