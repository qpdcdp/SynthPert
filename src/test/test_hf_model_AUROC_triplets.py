...
def main(args):
   ...
   # --- Load Model and Tokenizer (on main process first) ---
    ...
    # ==============================================================================
    # --- AUROC CALCULATION ON RANDOM SUBSETS  ---
    # ==============================================================================
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./output/triplets_dif_sft/sft_triplets_checkpoint-4000")
    parser.add_argument("--lora_checkpoint", type=str, default="./output/triplets_dif_sft/sft_triplets_checkpoint-4000")
