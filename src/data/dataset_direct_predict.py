...
class GeneRegulationListDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return_dict = {
            ...
            "solution": final_solution_text, # Target output from the model
            "raw_solution_lists": {
