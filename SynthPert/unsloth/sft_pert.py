...
# def parse_args():
#     parser = argparse.ArgumentParser(description='Gene Expression Prediction Training Arguments')
#     parser.add_argument('--model_name_or_path',
#                        default="unsloth/DeepSeek-R1-Distill-Llama-8B-unsloth",
#                        type=str,
#                        help='name of the base model')
#     parser.add_argument('--task',
#                        default="direct_prediction",
#                        type=str,
#                        choices=['COT', 'triplets'],
#                        help='task type: COT or triplets')
...
def get_training_args(args) -> TrainingArguments:
    ...
    output_dir = f"./output/SFT_{args.express_type}/{synth_data_name}/lora_COT"
