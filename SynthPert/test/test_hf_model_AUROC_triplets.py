...
def main(args):
    ...
    csv_data_directory = "/novo/projects/departments/mi/lwph/PertRL/data"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--AUROC_stage", type=str, default="dir")
    parser.add_argument("--test_script", type=str)
    parser.add_argument("--tool", type=str)
    parser.add_argument("--test_split_cell_lines", type=str, default = "default")
    parser.add_argument("--batch_size", type=int, default=64)
    parser.add_argument("--model_name", type=str)
    parser.add_argument("--output_dir", type=str, default="/novo/projects/departments/mi/lwph/PertRL/output/triplets_dif_sft/sft_triplets_checkpoint-4000")
    parser.add_argument("--lora_checkpoint", type=str, default="/novo/projects/departments/mi/lwph/PertRL/output/triplets_dif_sft/sft_triplets_checkpoint-4000")
    parser.add_argument("--num_auroc_subsets", type=int, default=3)
    parser.add_argument("--auroc_subset_percentage", type=float, default=0.20)
